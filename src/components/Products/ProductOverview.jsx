const ProductOverview = ({ children, product }) => {
    return (
        <div className="w-56 h-96 rounded-xl bg-gray-500 bg-opacity-30 backdrop-blur-2xl text-slate-300  flex flex-col justify-around">
            ...
            <div className="flex flex-col justify-start items-center pr-2 pl-2 pb-2">
                <div className="flex flex-row justify-between text-sm font-normal pt-1 pb-1 gap-1">
